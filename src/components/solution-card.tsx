...
import { Bookmark, BookmarkCheck, ChevronDown, Sparkles } from "lucide-react";
import {
  Card,
  CardContent,
  CardDescription,
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              variant="ghost"
              size="icon"
              aria-label={isOpen ? "Collapse archetype" : "Expand archetype"}
              aria-expanded={isOpen}
              aria-controls={`archetype-${archetype.id}`}
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="space-y-1">
                      ...
                      <div className="flex flex-wrap gap-2 text-[11px] font-medium uppercase tracking-wide text-muted-foreground">
                        ...
                        <span>Budget: {formatBudgetLabel(suggestion.budget)}</span>
                      </div>
                    </div>
                    <Button
